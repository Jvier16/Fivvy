...
html{font-size:16px}
body{background:var(--paper);color:var(--ink);font-family:'Plus Jakarta Sans',sans-serif;min-height:100vh;-webkit-font-smoothing:antialiased}
...
.logo{font-family:'Instrument Serif',serif;font-size:1.6rem;letter-spacing:-0.5px}
.logo em{font-style:italic;color:var(--muted)}
.badge{font-family:'IBM Plex Mono',monospace;font-size:.65rem;letter-spacing:1.5px;text-transform:uppercase;padding:.3rem .65rem;border:1px solid var(--line);border-radius:2px;color:var(--muted)}
.badge.pro{border-color:var(--gold);color:var(--gold);background:rgba(184,134,11,.06)}
.btn-upgrade{background:var(--ink);color:var(--paper);border:none;border-radius:3px;padding:.4rem .85rem;font-family:inherit;font-size:.8rem;font-weight:600;cursor:pointer}
.nav{display:flex;border-bottom:1px solid var(--line);margin-bottom:1.75rem}
.nav-btn{flex:1;padding:.9rem .5rem;background:none;border:none;border-bottom:2px solid transparent;font-family:'Plus Jakarta Sans',sans-serif;font-size:.82rem;font-weight:500;color:var(--muted);cursor:pointer;transition:all .15s;margin-bottom:-1px}
...
.hero-label{font-family:'IBM Plex Mono',monospace;font-size:.7rem;letter-spacing:2px;text-transform:uppercase;color:var(--muted);margin-bottom:.75rem}
.hero-amt{font-family:'Instrument Serif',serif;font-size:clamp(2.8rem,8vw,4.5rem);letter-spacing:-2px;line-height:1}
.pos{color:var(--green)}.neg{color:var(--red)}
.hero-sub{display:flex;justify-content:center;gap:2.5rem;margin-top:1.25rem}
.stat-label{font-family:'IBM Plex Mono',monospace;font-size:.62rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);margin-bottom:.2rem}
.stat-val{font-family:'Instrument Serif',serif;font-size:1.35rem;letter-spacing:-.5px}
.form-card{background:var(--card);border:1px solid var(--line);border-radius:4px;padding:1.25rem;margin-bottom:2rem}
.form-lbl{font-family:'IBM Plex Mono',monospace;font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);margin-bottom:.75rem}
...
.inp{width:100%;background:var(--paper);border:1px solid var(--line);border-radius:3px;padding:.6rem .75rem;font-family:'Plus Jakarta Sans',sans-serif;font-size:.875rem;color:var(--ink);outline:none;transition:border-color .15s}
...
.seg button{flex:1;padding:.6rem;border:none;background:none;font-family:'Plus Jakarta Sans',sans-serif;font-size:.8rem;font-weight:500;color:var(--muted);cursor:pointer;transition:all .15s}
.seg button.exp{background:var(--red);color:#fff}
.seg button.inc{background:var(--green);color:#fff}
.add-btn{background:var(--ink);color:var(--paper);border:none;border-radius:3px;padding:.6rem 1.1rem;font-family:'Plus Jakarta Sans',sans-serif;font-size:.875rem;font-weight:600;cursor:pointer;white-space:nowrap}
.sec-lbl{font-family:'IBM Plex Mono',monospace;font-size:.68rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);margin-bottom:.75rem}
...
.tx-meta{font-family:'IBM Plex Mono',monospace;font-size:.68rem;color:var(--muted);margin-top:.1rem}
.tx-amt{font-family:'Instrument Serif',serif;font-size:1.1rem;flex-shrink:0}
...
.empty{text-align:center;padding:3rem 0;color:var(--muted);font-family:'IBM Plex Mono',monospace;font-size:.78rem;letter-spacing:1px}
...
.bud-nums{font-family:'IBM Plex Mono',monospace;font-size:.68rem;color:var(--muted)}
...
.bud-pct{font-family:'IBM Plex Mono',monospace;font-size:.62rem;color:var(--muted);margin-top:.3rem;text-align:right}
.paywall{border:1.5px dashed var(--line);border-radius:4px;padding:2.5rem 1.5rem;text-align:center;margin-top:1.5rem}
.paywall h2{font-family:'Instrument Serif',serif;font-size:1.45rem;margin-bottom:.4rem}
...
.btn-pay{background:var(--ink);color:var(--paper);border:none;border-radius:3px;padding:.7rem 1.4rem;font-family:inherit;font-size:.875rem;font-weight:600;cursor:pointer}
...
.btoggle button{flex:1;padding:.52rem;border:none;background:none;font-family:inherit;font-size:.8rem;font-weight:500;color:var(--muted);cursor:pointer;transition:all .15s}
...
.plan-name{font-family:'IBM Plex Mono',monospace;font-size:.6rem;letter-spacing:1.5px;text-transform:uppercase;color:var(--muted);margin-bottom:.35rem}
.plan-price{font-family:'Instrument Serif',serif;font-size:1.5rem;letter-spacing:-.5px}
.plan-price span{font-family:inherit;font-size:.72rem;color:var(--muted);font-style:normal}
.plan-save{font-family:'IBM Plex Mono',monospace;font-size:.6rem;color:var(--green);margin-top:.15rem}
...
.order-total{display:flex;justify-content:space-between;font-family:'Instrument Serif',serif;font-size:1.05rem}
.methods{display:flex;flex-wrap:wrap;gap:.35rem;margin-bottom:.9rem}
.method{font-family:'IBM Plex Mono',monospace;font-size:.65rem;background:var(--cream);border:1px solid var(--line);border-radius:2px;padding:.18rem .45rem;color:var(--muted)}
.btn-main{width:100%;padding:.82rem;background:var(--ink);color:var(--paper);border:none;border-radius:3px;font-family:inherit;font-size:.9rem;font-weight:600;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:.4rem}
.btn-main:hover{opacity:.85}
.btn-main:disabled{opacity:.35;cursor:not-allowed}
.btn-ghost{width:100%;padding:.72rem;background:none;color:var(--ink);border:1px solid var(--line);border-radius:3px;font-family:inherit;font-size:.875rem;font-weight:500;cursor:pointer;margin-top:.45rem}
.btn-demo{background:none;border:none;color:var(--muted);font-family:'IBM Plex Mono',monospace;font-size:.65rem;cursor:pointer;text-decoration:underline;display:block;margin:.65rem auto 0}
.back-btn{background:none;border:1px solid var(--line);border-radius:3px;padding:.33rem .65rem;font-family:inherit;font-size:.78rem;cursor:pointer;margin-right:.65rem}
      ...
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        {step === "confirm" && <>
          ...
          <div className="order">
            ...
            {billing==="annual" && <div className="order-row"><span className="ol">Descuento</span><span style={{color:"var(--green)"}}>-$39.89</span></div>}
